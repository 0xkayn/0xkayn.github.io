...
file
```
some thinking and testing made me realize that eval will allow me to concatenate strings and then send that to the intepreter<br>
"impor" + "t o" + "s"
...
nc chall2.2019.redpwn.net 6007<br>
In this challenge, we had to find a way to get the contents of a file without being able to import any modules,
use most builtins, and were not allowed to use spaces in any commands either, so it was very challenging.<br>
This one isnt as much of a writeup, but its the process I took to solve the challenge.<br>
